...
function fuUPDATER () {
	...
	fuREMOVEOLDIMAGES "f0rc3ps/*:25.04"
	fuREMOVEOLDIMAGES "ghcr.io/nu11secur1ty/*:25.04"
	echo
	...
	echo "### https://raw.githubusercontent.com/nu11secur1ty/tpotce/master/etc/objects/kibana_export.ndjson.zip"
